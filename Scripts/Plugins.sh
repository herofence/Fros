...
#Passwall
git clone --depth=1 --single-branch https://github.com/herofence/openwrt-passwall.git
git clone --depth=1 --single-branch --branch "luci" https://github.com/herofence/openwrt-passwall.git ./pw_luci
git clone --depth=1 --single-branch --branch "packages" https://github.com/herofence/openwrt-passwall.git ./pw_packages
#Diskman
